...
CREATE TABLE `__new_diary_table` (
	...
	`date` text DEFAULT '2025-02-21T23:49:15.020Z' NOT NULL,
...
--> statement-breakpoint
INSERT INTO `__new_calorie_totals_table `("id", "type", "total") SELECT "id", "type", "total" FROM `calorie_totals_table `;--> statement-breakpoint
